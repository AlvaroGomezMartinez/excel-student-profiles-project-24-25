...
// New function to format the date as "M.D.YY" or "MM.DD.YY"
...
function uploadJpgToDrive(jpgBlob, studentName) {
  try {
    var folder = DriveApp.getFolderById('1iG6KdxrLW4SCH4iDMBfiSeA2JLS5ZzTU'); // Replace with your destination folder ID
